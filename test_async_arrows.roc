...
main! = |_|
    _ = Stdout.line!("🚀 Test Async Arrow Functions")
    _ = Stdout.line!("=============================\n")

    # Test simple async arrow function
    _ = test_single_case!("async x => x")

    # Test async arrow function with parentheses
    _ = test_single_case!("async (x) => x")

    # Test async arrow function with multiple parameters
    _ = test_single_case!("async (x, y) => x + y")

    # Test async arrow function with block body
    _ = test_single_case!("async x => { return x }")

    # Test async arrow function with await
    _ = test_single_case!("async x => await x")
