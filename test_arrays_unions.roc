...
main! = |_|
    _ = Stdout.line!("🚀 Test TypeScript Array and Union Types")
    _ = Stdout.line!("======================================\n")

    # Test array types
    _ = test_single_case!("type StringArray = string[]")
    _ = test_single_case!("type NumberArray = number[]")
    _ = test_single_case!("type BooleanArray = boolean[]")

    # Test nested arrays
    _ = test_single_case!("type Matrix = number[][]")
    _ = test_single_case!("type ThreeD = string[][][]")

    # Test union types
    _ = test_single_case!("type StringOrNumber = string | number")
    _ = test_single_case!("type Multiple = string | number | boolean")
    _ = test_single_case!("type Nullable = string | null | undefined")

    # Test arrays of union types
    _ = test_single_case!("type MixedArray = (string | number)[]")

    # Test union of arrays
    _ = test_single_case!("type ArrayUnion = string[] | number[]")

    # Test complex combinations
    _ = test_single_case!("type Complex = (string | number)[] | boolean")
