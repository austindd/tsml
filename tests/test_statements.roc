...
main! = |_|
    _ = Stdout.line!("Testing Return/Throw/Try-Catch Statement Implementation")
    _ = Stdout.line!("")

    # Test return statements
    _ = test_statement!("return;")
    _ = test_statement!("return 42;")
    _ = test_statement!("return x + y;")

    # Test throw statements
    _ = test_statement!("throw error;")
    _ = test_statement!("throw 'message';")

    # Test try-catch statements
    _ = test_statement!("try { code; } catch (e) { handle; }")
    _ = test_statement!("try { code; } catch { handle; }")
    _ = test_statement!("try { code; } finally { cleanup; }")

    Stdout.line!("All statement tests completed!")