...
main! = |_|
    _ = Stdout.line!("🚀 New Expression Tests")
    _ = Stdout.line!("========================\n")
    ...
    # New with member access (constructor from object)
    _ = test_single_case!("new MyClass.Builder();")

    Stdout.line!("🎉 All new expression tests completed!")