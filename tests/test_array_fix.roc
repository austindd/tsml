...
main! = |_|
    _ = Stdout.line!("🚀 Array Parsing Fix Test")
    _ = Stdout.line!("=========================\n")
    ...
    _ = test_single_case!("const mixed = [1, 'hello', true];")

    # Test nested arrays
    _ = test_single_case!("const nested = [[1, 2], [3, 4]];")

    # Test empty array
    _ = test_single_case!("const empty = [];")

    # Test single element array
    _ = test_single_case!("const single = [42];")

    Stdout.line!("🎉 All array tests completed!")