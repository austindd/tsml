...
main! = |_|
    _ = Stdout.line!("🚀 Test TypeScript Index Signatures")
    _ = Stdout.line!("====================================\n")

    # Test basic index signature
    _ = test_single_case!("type StringDict = { [key: string]: any };")

    # Test number index signature
    _ = test_single_case!("type NumberArray = { [index: number]: string };")

    # Test readonly index signature
    _ = test_single_case!("type ReadonlyDict = { readonly [key: string]: number };")

    # Test mixed properties and index signature
    _ = test_single_case!("type Mixed = { length: number; [key: string]: any };")

    # Test optional properties
    _ = test_single_case!("type Optional = { name?: string; age?: number };")

    # Test readonly properties
    _ = test_single_case!("type ReadonlyProps = { readonly id: number; readonly name: string };")

    # Test complex combination
    _ = test_single_case!("type Complex = { readonly id: number; name?: string; [key: string]: any };")
