...
main! = |_|
    _ = Stdout.line!("🚀 Test TypeScript Literal Types")
    _ = Stdout.line!("=================================\n")

    # Test basic literal types
    _ = test_single_case!("type Num = 42;")
    _ = test_single_case!("type Str = \"hello\";")
    _ = test_single_case!("type Bool = true;")
    _ = test_single_case!("type BoolFalse = false;")

    # Test template literal types
    _ = test_single_case!("type Template = `hello world`;")

    # Test union of literal types
    _ = test_single_case!("type Status = \"active\" | \"inactive\" | \"pending\";")
    _ = test_single_case!("type Code = 200 | 404 | 500;")
    _ = test_single_case!("type Mixed = 42 | \"str\" | true;")

    # Test bigint literals
    _ = test_single_case!("type BigNum = 123n;")
