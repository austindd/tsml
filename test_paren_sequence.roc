...
main! = |_|
    _ = Stdout.line!("🚀 Parenthesized Sequence Expression Test")
    _ = Stdout.line!("========================================\n")

    # Test simple parenthesized expression (should work)
    _ = test_single_case!("const a = (42);")

    # Test parenthesized sequence expression (problematic)
    _ = test_single_case!("const x = (doSomething(), [1, 2, 3]);")

    # Test simpler sequence
    _ = test_single_case!("const y = (1, 2);")

    # Test function call in sequence
    _ = test_single_case!("const z = (func(), 42);")

    Stdout.line!("🎉 All parenthesized expression tests completed!")