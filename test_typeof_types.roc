...
main! = |_|
    _ = Stdout.line!("🚀 Test TypeScript Typeof Types")
    _ = Stdout.line!("===============================\n")

    # Test typeof type operator
    _ = test_single_case!("type x = typeof y")
    _ = test_single_case!("type MyType = typeof someVariable")
    _ = test_single_case!("type ComponentType = typeof MyComponent")

    # Test typeof with variable declarations
    _ = test_single_case!("let config: typeof defaultConfig = {...}")
