...
main! = |_|
    _ = Stdout.line!("🚀 Test Switch Statements")
    _ = Stdout.line!("========================\n")

    # Test basic switch statement
    _ = test_single_case!("switch (x) { case 1: break; }")

    # Test switch with multiple cases
    _ = test_single_case!("switch (value) { case 'a': console.log('A'); break; case 'b': console.log('B'); break; }")

    # Test switch with default case
    _ = test_single_case!("switch (day) { case 1: return 'Monday'; default: return 'Unknown'; }")

    # Test switch with fall-through cases
    _ = test_single_case!("switch (num) { case 1: case 2: case 3: return 'small'; case 4: case 5: return 'medium'; default: return 'large'; }")

    # Test switch with block statements in cases
    _ = test_single_case!("switch (action) { case 'save': { saveFile(); console.log('Saved'); break; } default: console.log('Unknown action'); }")
