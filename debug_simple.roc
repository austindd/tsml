...
main! = |_|
    _ = Stdout.line!("🚀 Simple Debug")
    _ = Stdout.line!("===============\n")

    # Test just function call
    _ = test_single_case!("func()")

    # Test function call in assignment
    _ = test_single_case!("const x = func()")

    # Test sequence expression WITHOUT function call (should work)
    _ = test_single_case!("const x = (a, b)")

    # Test sequence expression WITH function call (should break)
    _ = test_single_case!("const x = (func(), b)")
