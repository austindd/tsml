...
main! = |_|
    _ = Stdout.line!("🚀 Debug Sequence Expression Issues")
    _ = Stdout.line!("====================================\n")

    # These should work:
    _ = test_single_case!("a, b")               # Simple sequence (no parens)
    _ = test_single_case!("func(), b")          # Function call + sequence (no parens)
    _ = test_single_case!("(a, b)")             # Simple sequence in parens

    # This breaks:
    _ = test_single_case!("(func(), b)")        # Function call + sequence in parens

    Stdout.line!("🎉 Debug complete!")